...
The packing_defect *Code of Conduct* sets the rules for the behavior of
every member in the packing_defect community so that everyone can
...
packing_defect is part of an engaged and respectful community made up of people from all
...
avoid, you will help us make packing_defect a welcoming and productive community.
...
7. **When we disagree, try to understand why**. Disagreements, both social and
   technical, happen all the time and packing_defect is no exception. It is important
   that we resolve disagreements and differing views constructively. Remember
   that we’re different. The strength of packing_defect comes from its varied community
...
reported by contacting the project team at 'jaybraunjr@gmail.com'. The project team will
