...
# Add all submodules under packing_defect
autosummary_imported_modules = find_submodules(packing_defect)

# -- Project information -----------------------------------------------------

project = "packing_defect"
copyright = (
    "2025, R. Jay Braun. "
...
htmlhelp_basename = "packing_defectdoc"
...
latex_documents = [
    (master_doc, "packing_defect.tex", "packing_defect Documentation",
     "packing_defect", "manual"),
]
...
man_pages = [
    (master_doc, "packing_defect", "packing_defect Documentation",
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, "packing_defect", "packing_defect Documentation",
     author, "packing_defect", "membrane packing defect analysis",
     "Miscellaneous"),
]
