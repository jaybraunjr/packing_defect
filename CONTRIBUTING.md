...
We welcome all contributions to packing_defect!

Contributions can take many forms, such as:

* sharing bug reports or feature requests through the [Issue Tracker](https://github.com/jaybraunjr/packing_defect/issues)
...
The second two options both involve making a [pull request](https://github.com/jaybraunjr/packing_defect/pulls) .
